...
export const metadata: Metadata = {
  ...
  description:
    "Chính sách thu thập, lưu trữ, sử dụng và bảo mật thông tin cá nhân của khách hàng khi đặt xe sân bay Nội Bài tại inoibai.vn.",
  alternates: {
    canonical: "/chinh-sach/bao-ve-quyen-rieng-tu",
  },
  openGraph: {
    title: "Chính sách bảo vệ quyền riêng tư | inoibai.vn",
    description:
  ...
  twitter: {
    card: "summary",
    title: "Chính sách bảo vệ quyền riêng tư | inoibai.vn",
    description: "Chính sách bảo mật thông tin khách hàng tại inoibai.vn.",
  },
};
    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 md:px-12 lg:px-24 py-6 md:py-10">
        ...
        <div className="bg-white rounded-2xl p-6 md:p-8 mb-6 shadow-sm border border-gray-100">
          ...
          >
            <p>
              ...
              khi Quý khách ở trong trang web inoibai.vn, và khi Quý khách sử dụng các dịch vụ đặt xe sân bay của chúng tôi hoặc dịch
        ...
        <div className="bg-white rounded-2xl p-6 md:p-8 mb-6 shadow-sm border border-gray-100">
          ...
          >
            <p>
              Theo thực tiễn đôi khi chúng tôi có thể sửa đổi quy định này. Mọi thay đổi sẽ được cập nhật công khai trực tiếp trên website inoibai.vn.
            </p>
          </div>
        </div>
