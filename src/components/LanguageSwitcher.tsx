  ...
  return (
    <div className="relative inline-block text-left" ref={dropdownRef}>
      <button
        ...
        className="inline-flex items-center gap-1.5 px-3 py-1.5 border border-gray-200 hover:border-brand-steel bg-white text-gray-700 text-xs md:text-sm font-semibold shadow-xs hover:text-[#003366] transition-all cursor-pointer"
      ...
      {isOpen && (
        <div className="absolute right-0 mt-1.5 w-44 bg-white shadow-xl border border-gray-100 py-1.5 z-50 animate-in fade-in-50 zoom-in-95 duration-150">
