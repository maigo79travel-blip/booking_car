        ...
        <div className="space-y-2">
          <div className="relative flex items-center">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-300 text-xs font-medium text-slate-900 outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-100 bg-white"
            />
          </div>

          {value && (
            <div className="relative w-28 h-20 rounded-xl overflow-hidden bg-slate-100 border border-slate-200">
              <Image
                src={value}
                alt="Preview"
                fill
